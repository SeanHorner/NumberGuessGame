    ...
    level match {
      ...
      case 2 =>
        ...
        print("* As you spill out of that portal, you hear laser blasts all around you!    *\n"
            ...
            + "* him off.                                                                  *\n\n"
            + "Morty: Aw, geez, Rick! There's like 50 guys trying to shoot us! What is I\n"
            + "       get shot?!\n\n"
            + "Rick:  Well then let's make it easy! If you don't do it, I will shoot you!\n\n"
    ...
    level match {
      case 1 =>
        print("* Success! The computer logs in just as Rick finally bests the              *\n"
            + "* battle-hardened Gazorpgazorpian. He leaps over to your side of the hovel  *\n"
            + "* and enters a couple lines of code.                                        *\n\n"
      ...
      case 3 =>
        print("* Success! The console logs into the server. You turn around in time to see *\n"
            ...
            + "* it might accidently eat up anything else. Oh well, no time for that now.  *\n\n")
      case 4 =>
        print("Fourth success message!\n\n")
      case 5 =>
    ...
    level match {
      case 1 =>
        print("* Wrong! The computer shuts down with a loud siren: you've tripped the      *\n"
            ...
            + "* the tip of a Gazorpzgazorpian spear bursts forth from Rick's chest,       *\n"
      ...
      case 3 =>
        print("* Failure! But the console offers you another chance. It reads:             *\n\n"
            ...
            + "* dparks, you turn to Rick. As soon as you do, you feel the invisible hand  *\n"
      ...
      case 4 =>
        print("* Wrong! The console disappears in a puff of smoke! You turn to Rick to     *\n"
